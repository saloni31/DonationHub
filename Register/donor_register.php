...
if (isset($_POST['add'])) {
    ...
    if (empty($err) && empty($mailerr) && empty($passerr) && empty($conpaaerr) && empty($Adderr) && empty($cityerr) && empty($areaerr)) {
        ...
        $sql1 = "insert into user (roleId,email,password) values (3,'$email','$password')";
        $result1 = mysqli_query($conn, $sql1);
        $id = mysqli_insert_id($conn);
        if ($result1) {
            $sql = "insert into donor(userId,fullname,contactno,address,city,area_name)values($id,'$firstname','$mobile','$address','$city','$area')";
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        ...
                                        <input type="password" name="confirmPassword" class="form-control"
                                               placeholder="Confirm password" id="con_pass"
                                               value="<?php if (isset($conpaa)) echo $conpaa ?>">
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                ...
                                <input type="text" name="inputcontactno" class="form-control"
                                       placeholder="Mobile no" value="<?php if (isset($mobile)) echo $mobile ?>">
                            </div>
